...
- [ ] Animated word-highlight captions — ASS karaoke-style captions burned into clips (word highlights as it's spoken); biggest visual differentiator. Preset styles + hex active-word color picker + size + position controls
